...
<body>
	<div>
		...
		<form method="post" action="${pageContext.request.contextPath }/MyController?cmd=update_ok" enctype="multipart/form-data">
			<table>
				<tbody>
						...
						<td>
					 		<c:choose>
					 			...
					 			<c:otherwise>
					 				...
					 				<input type="hidden" name="f_name2" 
					 				value="${vo.f_name}">이전 파일 (${vo.f_name})
					 			</c:otherwise>
					 		</c:choose>
					 	</td>
					</tr>
